...
def test_color4u8():
    ...
    color = Color4U8(0, 0, 0, 0)
    assert(color.r == 0)
    assert(color.g == 0)
    assert(color.b == 0)
    assert(color.a == 0)

    color = Color4U8(0, 0, 0)
    assert(color.r == 0)
    assert(color.g == 0)
    assert(color.b == 0)
    assert(color.a == 255)

    color = Color4U8(11, 22, 33, 44)
    assert(color.r == 11)
    assert(color.g == 22)
    assert(color.b == 33)
    assert(color.a == 44)
    ...
    color = Color4U8(11, 22, 33, 44).to_color4u8()
    assert(color.r == 11)
    assert(color.g == 22)
    assert(color.b == 33)
    assert(color.a == 44)

    color = Color4U8(255, 255, 255, 255).to_color4f()
    ...
    color = Color4U8(127, 127, 127, 127).to_color4f()
    ...
    color = Color4U8(0, 0, 0, 0).to_color4f()
    ...
    color = Color4U8(0, 63, 127, 255).to_color4f()
...
def test_color4f():
    ...
    color = Color4F(0.1, 0.2, 0.3, 0.4).to_color4f()
    assert(color.r == 0.1)
    assert(color.g == 0.2)
    assert(color.b == 0.3)
    assert(color.a == 0.4)

    color = Color4F(1, 1, 1, 1).to_color4u8()
    assert(color.r == 255)
    assert(color.g == 255)
    assert(color.b == 255)
    assert(color.a == 255)

    color = Color4F(0.5, 0.5, 0.5, 0.5).to_color4u8()
    assert(color.r == 127)
    assert(color.g == 127)
    assert(color.b == 127)
    assert(color.a == 127)

    color = Color4F(0, 0, 0, 0).to_color4u8()
    assert(color.r == 0)
    assert(color.g == 0)
    assert(color.b == 0)
    assert(color.a == 0)

    color = Color4F(0, 0.25, 0.5, 1).to_color4u8()
    assert(color.r == 0)
    assert(color.g == 63)
    assert(color.b == 127)
    assert(color.a == 255)
    ...
    try:
        color = Color4F(0.1, 0.2, "text", 0.3)
    except Exception as e:
