...
def draw():
    ...
    _data.text_drawer.set_color(255, 255, 255, 255) # optional
    _data.text_drawer.set_pos(10, _data.height - _FONT_SIZE)
    _data.text_drawer.render_text(_data.font, togl.FineText("White text.\n", (255, 0, 0, 255), "Red text.\n", (0, 255, 0, 255), "Green text.\n", (255, 255, 255, 67), "Transparent text.\n", (255, 255, 255, 255), "Escape - Exit."))
